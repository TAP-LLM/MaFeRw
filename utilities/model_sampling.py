...
class T5Sampling(nn.Module):
    ...
    def sampling(
        ...
        min_length = sampling_kwargs.get('min_length', input_ids.shape[1]//3)
        ...
        # generation_config = GenerationConfig.from_dict(logits_proc_kwargs)
        # logits_processor = self.model._get_logits_processor(generation_config,
        #                                                     prefix_allowed_tokens_fn=sampling_kwargs.get('prefix_allowed_tokens_fn', None))
        #
        # # get probability distribution warper
        # generation_config = GenerationConfig.from_dict(logits_warper_kwargs)
        ...
        while cur_len < max_length:
            ...
            if cur_len < min_length:
                next_token_logits[0, pad_token_id] = -float('inf')
